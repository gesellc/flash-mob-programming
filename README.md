...
Can a small set of rules applied only for a short amount of time help a newly formed mob to build trust quickly?
...
Navigators figure out where we are going, step by step, and the driver puts those steps into the computer. Roles change in a rotation through the whole team, typically triggered by a timer.

_"For an idea to go from someone's head into the computer it must go through someone else's hands."_ - Llewellyn Falco

## Two essentials

- **Turn up the good** - Repeatedly emphasizing the good things you want more of is actionable, easier to digest than the opposite and - according to Woody - usually let's the bad things fade away. 
- **Kindness, Consideration, Respect** - How Woody's team decided to treat each other.

# Flash Mob Programming - Trust First

What we will do today is mob programming with a few different guidelines to focus on trust before we improve performance.

What about the essentials?

- **Turn up the good**: We will run quick retros after short time frames to improve as a teams.
- **Kindness, Consideration, Respect**: That is basically the focus of the exercise, but start by thinking "What can I do (or not do) to make my teammates awesome".

One facilitation Tip: We want to jump into mobbing fast to make this an valuable experience within a short time frame. So when in doubt let's follow Mike Burrow's principle _"Experience before Explanation"_.

## Round 1 Objective: Build trust

This is our pre-agreed working agreement for at least the first round of mobbing:
...
- Strong style navigation
    - 1 Driver:
        ...
        - Give hints to driver to navigate on the correct level of abstraction
    - 1 Navigator:
        - Communicate your intent to the team
        - Tell driver what to do on the best level of abstraction for the driver 
        - Actively ask team for help
        - Bring an idea in play to its natural conclusion rather than starting your own
    - Mobbers:
...
## Continue and keep turning up the good
...
Run a quick Micro Retro after each round of mobbing.

**"Turn up the good"**

Focus on what you can do right away. The closing retro could be used for longer discussions.
